...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ request()->is('admin/obat') || request()->is('admin/obat/create') || request()->is('admin/obat/*/edit')? 'active' : '' }}">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/admin/obat">Daftar Obat</a>
                        <a class="collapse-item" href="/admin/obat/create">Tambah Obat</a>
                    </div>
                </div>
            </li>

            <li class="nav-item {{ request()->is('admin/stokin') || request()->is('admin/stokout') ? 'active' : '' }}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseTwo">
                    ...
                    <span>Stok In/Out</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/admin/stokin">Stok in</a>
                        <a class="collapse-item" href="/admin/stokout">Stok Out</a>
                    </div>
                </div>
            </li>
